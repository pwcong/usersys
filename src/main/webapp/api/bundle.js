	...
	fetch('/user/register.action', {
		...
		body: JSON.stringify({
			user: {
				...
				pwd: (0, _blueimpMd2.default)(document.getElementById('input-pwd-register').value)
			}
		})
	}).then(function (response) {
		return response.json();
	...
	fetch('/user/modify_password.action', {
		...
		body: JSON.stringify({
			user: {
				...
				pwd: (0, _blueimpMd2.default)(document.getElementById('input-pwd-modify-pwd').value)
			},
			target: {
				uid: document.getElementById('input-uid-modify-pwd-target').value,
				pwd: (0, _blueimpMd2.default)(document.getElementById('input-pwd-modify-pwd-target').value)
			}
		})
	}).then(function (response) {
		return response.json();
	...
	fetch('/user/modify_group.action', {
		...
		body: JSON.stringify({
			user: {
				...
				pwd: (0, _blueimpMd2.default)(document.getElementById('input-pwd-modify-group').value)
			},
			target: {
